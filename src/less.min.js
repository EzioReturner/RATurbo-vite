              ...
              (g.prototype.loadFile = function(a, b, c, d, e) {
                ...
                if (c.useFileCache && f[h])
                  ...
                  this.doXHR(
                    ...
                    function(a, b) {
                      (f[h] = a),
                        e(null, { contents: a, filename: h, webInfo: { lastModified: b } });
                    },
                    function(a, b) {
        ...
        function(a, b, c) {
          var d = a('../less-error'),
            ...
            i = function j(a, b, c) {
              function i(a, e) {
                throw new d(
                  { index: o.i, filename: c.filename, type: e || 'Syntax', message: a },
                  b
                );
              }
              function k(a, b, c) {
                ...
                parse: function(g, h, i) {
                  ...
                  if (!u.isFinished) {
                    ...
                    v ||
                      ...
                      (p = new d(
                        { type: 'Parse', message: v, index: u.furthest, filename: c.filename },
                        b
                      ));
                  }
                  var w = function(a) {
              ...
              for (
                ...
                if ((c = a.frames[j].find(this.selector, null, s)).length > 0) {
                  for (n = !0, k = 0; k < c.length; k++) {
                    ...
                    m ||
                      (d.matchArgs(t, a) &&
                        ((o = { mixin: d, group: b(d, e) }), o.group !== y && w.push(o), (v = !0)));
                  }
